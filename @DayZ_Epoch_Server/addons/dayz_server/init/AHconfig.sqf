...
_ALLOWED_Dialogs = [-1,106,2200,6900,6901,6902,6903,420420,41144,711194,666,667,55510,711195];
...
/*  If "_UVC =  false;" and "_UVW =  true;" this will delete all vehicles that are not in "_ALLOWED_Vehicles"  */
...
[
	...
	"BTC_Hud","PlotManagement","DoorManagement","Entercode",
...
[
	...
	"s_player2427_copyToKey","SP_refuel_action","SP_repair_action","SP_rearm_actions","s_player_setVectorsReset","s_player_setVectorsForward",
