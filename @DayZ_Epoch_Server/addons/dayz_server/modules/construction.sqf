...
_debug_marker setMarkerAlpha 1;
 ...
 _msgDebug = "<t align='center' color='#FF0000' shadow='2' size='1.75'>Atention!</t><br/><img size='4.75' image='fixes\GUI\treasure_hunt\Construction_ICON.paa'/><br/><t align='center' color='#ffffff'>IKEA truck has just lost it's cargo. Find it befere anyone else will.</t>";
