...
class CfgBuildingLoot {
	...
	class Military: Default {
		...
		lootType[] = {
			...
			{ "assaultrifles", "cfglootweapon", 0.50 },
			{ "sniperrifles", "cfglootweapon", 0.25 },
			{ "shotgunsingleshot", "cfglootweapon", 0.25 },
			{ "submachinegun", "cfglootweapon", 0.25 },
	...
	class Hunting: Default {
		...
		lootType[] = {
			...
			{ "farmweapons", "cfglootweapon", 0.33 },
			{"","military",0.38},
	...
	//If you want to copy your loot table to your mission w/o
