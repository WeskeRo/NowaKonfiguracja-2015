...
*/
#define VIP_ITEMS "ItemAntibiotic","ItemBloodbag","ItemBloodbag","ItemMorphine","ItemPainkiller","PartGeneric","PartEngine","ItemWaterbottle","FoodPistachio" // constant example, these can be removed if they are not used below
#define VIP_TOOLS "Kostey_notebook","Binocular_Vector","NVGoggles","ItemCompass","ItemKnife","Itemetool","ItemGPS","ItemCrowbar","ItemRadio","ItemToolbox"

_currencyVariable = "cashMoney"; // Coins variable name
_startBag = "DZ_Patrol_Pack_EP1"; // Use "" for none
_startMags = ["ItemBandage",3,"ItemPainkiller","PartGeneric","ItemWaterbottle","FoodPistachio","17Rnd_9x19_glock17",3];
_startWeps = ["ItemMap","Kostey_notebook","ItemFlashlight","ItemToolbox","glock17_EP1","ItemRadio"];
_customLoadout = [
	"76561198115644477", // Viktor 06/01/2016
	"76561198121993182",
	"0"
];
_customLoadouts = [
	["Victor's Loadout","GUE_Soldier_2_DZ","BanditW2_DZ",["RH_20Rnd_762x51_SD_hk417",7,"Skin_GUE_Soldier_Sniper_DZ"],["RH_hk417sdsp",VIP_TOOLS],"DZ_Backpack_EP1",["5Rnd_86x70_L115A1",9,VIP_ITEMS],["BAF_LRR_scoped_W"],0],
	["WeskeR's Loadout","GUE_Soldier_2_DZ","BanditW2_DZ",["RH_20Rnd_762x51_SD_hk417",7,"Skin_GUE_Soldier_Sniper_DZ"],["RH_hk417sdsp",VIP_TOOLS],"DZ_Backpack_EP1",["5Rnd_86x70_L115A1",9,VIP_ITEMS],["BAF_LRR_scoped_W"],1000],
	[]
];

_classLevel1 = ["0","0","0"];
_classLevel2 = ["0","0","0"];
_classLevel3 = ["76561198037083650","0","0"];
...
_publicClasses = [
	...
	["Czech Soldier","CZ_Special_Forces_GL_DES_EP1_DZ","SurvivorWcombat_DZ",["30Rnd_762x39_SA58",2],["Sa58P_EP1"],"",[],[],0,0,0],
	["Police Officer","RU_Policeman_DZ","SurvivorWdesert_DZ",["8Rnd_B_Beneli_74Slug",3],["M1014"],"",[],[],0,0,0],
	["Rocker","Rocker1_DZ","SurvivorWurban_DZ",["30Rnd_9x19_MP5SD",2],["MP5SD"],"",[],[],0,0,0],
	["Terrorist","TK_INS_Soldier_EP1_DZ","BanditW2_DZ",["30Rnd_545x39_AK",2],["AK_74"],"",[],[],0,0,0],
