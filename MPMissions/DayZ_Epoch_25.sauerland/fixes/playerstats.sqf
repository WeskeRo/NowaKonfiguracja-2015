...
_name = if (alive player) then {name player;} else {"Dead Player";};
	...
	<t size='1.4' font='Bitstream' align='center' color='#C70000'>DAYZ RVL OverPoch</t><br/>
	...
	<t size='1.15' font='Bitstream' align='center' color='#DDDDDD'>TS: 51.254.223.190</t><br/>",
	(name player),
	...
	[(player getVariable['cashMoney', 0])] call BIS_fnc_numberText, //11
	[(player getVariable['bankMoney', 0])] call BIS_fnc_numberText//12
	];
